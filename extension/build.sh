...
PACK_FILES="browser-polyfill.js settings-schema.js activity-store.js ad-blocker.js archive-fs.js background.js platform.js core-routing.js core-selectors.js core-video-cards.js core-media.js content.js worker.js mediabunny-worker.js offscreen.html offscreen.js"
