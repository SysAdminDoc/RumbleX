...
const INIT_STYLE_IDS = Object.freeze({
    ...
    chatUserBlock: 'rx-chatuserblock-css', chatSpamDedup: 'rx-spamdedup-css',
    rantPersist: 'rx-rantpersist-css', commentSort: 'rx-commentsort-css',
    commentExport: 'rx-comment-export-css', keywordFilter: 'rx-keywordfilter-css',
