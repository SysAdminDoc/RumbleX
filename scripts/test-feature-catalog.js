...
assert.equal(handwritten.length, 87, 'handwritten feature count changed; update behavior coverage intentionally');
assert.equal(cssIds.length, 51, 'CSS feature count changed; update behavior coverage intentionally');
assert.equal(handwritten.length + cssIds.length, 138, 'total feature catalog changed unexpectedly');
