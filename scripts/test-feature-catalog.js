...
assert.equal(handwritten.length, 88, 'handwritten feature count changed; update behavior coverage intentionally');
assert.equal(cssIds.length, 51, 'CSS feature count changed; update behavior coverage intentionally');
assert.equal(handwritten.length + cssIds.length, 139, 'total feature catalog changed unexpectedly');
