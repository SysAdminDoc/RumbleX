...
assert.equal(handwritten.length, 90, 'handwritten feature count changed; update behavior coverage intentionally');
assert.equal(cssIds.length, 51, 'CSS feature count changed; update behavior coverage intentionally');
assert.equal(handwritten.length + cssIds.length, 141, 'total feature catalog changed unexpectedly');
